...
Color DiffuseMaterial::calculateColor(const Ray &ray,
									  const IntersectData &hit_data,
									  int depth, const Scene &scene) const {
	return kEmissive + directIllumination(ray, hit_data, scene);
}
