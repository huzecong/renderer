...
int main() {
	...
	Material *wall_material = DiffuseMaterial(One * 0.433, One * 0.217);
...
//	scene.addObject(new TexturedSphere({1.95, -3 + 1, -2}, 1, new GlossyMaterial(One * 0.5, One * 0.2), "/Users/kanari/CLionProjects/renderer/texture/Ball 15.jpg", {0.5, 0.5, 0.5}, {-0.5, 0.5, 0.5}));
	scene.addObject(new TexturedSphere({1.95, -3 + 1, -2}, 1, &(new Material())->setDiffuse(One * 0.5, One * 0.2).setSpecular(One * 0.7, One * 0.1, 50).setReflect(One * 0.3), "/Users/kanari/CLionProjects/renderer/texture/Ball 15.jpg", {0.5, 0.5, -0.5f}, {-0.5f, 0.5, -0.5f}));
