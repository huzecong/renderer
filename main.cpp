...
int main() {
	...
	Material *wall_material = DiffuseMaterial(One * 0.33, One * 0.13);
...
//	scene.addObject(new TexturedSphere({1.95, -3 + 1, -2}, 1, new GlossyMaterial(One * 0.5, One * 0.2), "/Users/kanari/CLionProjects/renderer/texture/Ball 15.jpg", {0.5, 0.5, 0.5}, {-0.5, 0.5, 0.5}));
	scene.addObject(new TexturedSphere({1.95, -3 + 1, -2}, 1, &(new Material())->setDiffuse(One * 0.3, One * 0.1).setSpecular(One * 0.5, One * 0.1, 50).setReflect(One * 0.05), "/Users/kanari/CLionProjects/renderer/texture/Ball 15.jpg", {0.5, 0.5, -0.5f}, {-0.5f, 0.5, -0.5f}));
...
//	scene.addObject(new Plane({-1.5f, 3 - (float)kEps / 2, -1.5f}, {3, 0, 0}, {0, 0, 3}, EmissiveMaterial(One * 10), One));	// Light
	...
	scene.loadEnvironment("/Users/kanari/CLionProjects/renderer/environment/rnl_probe.pfm");
